          ...
          <Row>
              ...
              <Card style={{ width: "18rem" }}>
                ...
                <Card.Body>
                  ...
                  <Card.Text className="text-dark">
                    ...
                    <span style={{ color: "red" }}>5%</span> de cashback
                  </Card.Text>
                  <Button variant="dark">Quero meu cupom!</Button>
                </Card.Body>
              </Card>
            </Col>
            <Col>
              <Card style={{ width: "18rem" }}>
                ...
                <Card.Body>
                  ...
                  <Card.Text className="text-dark">
                    Pegue o seu cupom de{" "}
                    <span style={{ color: "red" }}>10%</span> de cashback
                  </Card.Text>
                  <Button variant="dark">Quero meu cupom!</Button>
                </Card.Body>
              </Card>
            ...
            <Col>
              <Card style={{ width: "18rem" }}>
                ...
                />
                <Card.Body>
                  <Card.Title className="text-dark">Nike</Card.Title>
                  <Card.Text className="text-dark">
                    Pegue o seu cupom de{" "}
                    <span style={{ color: "red" }}>15%</span> de cashback
                  </Card.Text>
                  <Button variant="dark">Quero meu cupom!</Button>
                </Card.Body>
              </Card>
            ...
            <Col>
              <Card style={{ width: "18rem" }}>
                <Card.Img
                  style={{ width: "100%", height: "170px" }}
                  variant="top"
                  src="https://www.radioprogresso.com.br/wp-content/uploads/2019/10/lojas-americanas.png"
                />
                <Card.Body>
                  ...
                  <Card.Text className="text-dark">
                    Pegue o seu cupom de{" "}
                    <span style={{ color: "red" }}>25%</span> de cashback
                  </Card.Text>
                  <Button variant="dark">Quero meu cupom!</Button>
                </Card.Body>
              </Card>
